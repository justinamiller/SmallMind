...
namespace SmallMind.Core.Utilities
{
    ...
    /// <summary>
    /// Canonical helper for chat template formatting.
    /// Pure, stateless functions for formatting messages according to different chat templates.
    /// Used across Engine and Console projects to avoid duplication.
    /// </summary>
    internal static class ChatTemplateFormatter
    {
        ...
        /// </summary>
        /// <param name="message">The message content to format</param>
        /// <param name="template">The chat template type to use</param>
        ...
        internal static string Format(string message, ChatTemplateType template, bool isSystemMessage = false)
        {
            return template switch
            {
                ...
                _ => message // No template or Auto
            };
        }

        /// <summary>
        /// Detect template type from model name or path and metadata.
        /// </summary>
        /// <param name="modelNameOrPath">The model name or path</param>
        /// <param name="metadata">Optional metadata dictionary</param>
        /// <returns>The detected template type</returns>
