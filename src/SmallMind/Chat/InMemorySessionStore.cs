...
namespace SmallMind.Chat
{
    ...
    public class InMemorySessionStore : ISessionStore
    {
        ...
        /// Get a session by ID.
        /// </summary>
        public Task<ChatSession?> GetAsync(string sessionId, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public Task UpsertAsync(ChatSession session, CancellationToken cancellationToken = default)
        {
            if (session == null)
