...
All results above were collected using the SmallMind benchmark harness (`src/SmallMind.Benchmarks/`).
For full methodology, configuration options, and instructions on running benchmarks locally
(including real-model inference benchmarks), see **[docs/benchmarking.md](docs/benchmarking.md)**.
