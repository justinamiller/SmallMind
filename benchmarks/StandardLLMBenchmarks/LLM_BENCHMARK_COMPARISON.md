...
**Generated:** 2026-02-07 17:43:08 UTC  
...
- **Matrix Multiplication (512×512):** 1.97 GFLOPS
- **Memory Bandwidth:** 17.52 GB/s
...
|-----------|-------|------|---------|
| MatMul 256×256 | 1.92 | GFLOPS | 17.47 ms/op |
| MatMul 512×512 | 1.97 | GFLOPS | 136.59 ms/op |
| MatMul 1024×1024 | 2.01 | GFLOPS | 1070.84 ms/op |
| MatMul 2048×2048 | 1.74 | GFLOPS | 9883.99 ms/op |
| Element-wise Add | 17.52 | GB/s | 6.377 ms/op |
| ReLU Activation | 10.19 | GB/s | 0.731 ms/op |
| GELU Activation | 2.00 | GB/s | 3.728 ms/op |

## 🔢 Memory Performance

| Benchmark | Value | Unit | Details |
|-----------|-------|------|---------|
| Allocation Rate | 38.17 | MB | 0.0196 ms per 40KB allocation |
...
| Benchmark | Value | Unit | Details |
|-----------|-------|------|---------|
| Memory Copy | 20.05 | GB/s | 4.644 ms/op |
| Dot Product | 2.13 | GFLOPS | 9.380 ms/op |
...
|-----------|----------|---------------|-------------------|------------------|------------|--------------|
| **SmallMind** | C# | 2.0 | 17.5 | 20 MB | 50 | Zero |
...
- **vs. llama.cpp:** ~3% of performance (expected due to C# vs hand-optimized C++)
- **vs. PyTorch CPU:** Comparable or better for small models
- **vs. Transformers.js:** 3-5x faster (C# SIMD vs JavaScript)
- **vs. ONNX Runtime:** ~2% (ONNX has hardware-specific optimizations)
...
*Timestamp: 2026-02-07 17:43:08 UTC*
